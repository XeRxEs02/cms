      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-blue-900">{weekData.totalDays}</p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-center">Work Type</th>
              ...
              <tbody className="divide-y">
                {Object.entries(weekData.dailyBreakdown).map(([day, data]) => (
                  <tr key={day} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 text-center">{data.workType || '-'}</td>
